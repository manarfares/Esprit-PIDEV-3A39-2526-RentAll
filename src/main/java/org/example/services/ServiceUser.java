...
public class ServiceUser implements IService<User> {
    ...
    public void ajouter(User user) {
        ...
        try {
            ...
            ps.executeUpdate();
            System.out.println("✅ User ajouté : " + user.getUsername());
    ...
    public void modifier(User user) {
        ...
        try {
            ...
            ps.executeUpdate();
            System.out.println("✅ User modifié : " + user.getUsername());
        } catch (SQLException e) {
    ...
    public void supprimer(User user) {
        ...
        try {
            ...
            ps.executeUpdate();
            System.out.println("✅ User supprimé : " + user.getUsername());
        } catch (SQLException e) {
    ...
    public boolean verifierToken(int id, String token) {
        String sql = "SELECT session_token FROM users WHERE id=?";
        try {
            PreparedStatement ps = connection.prepareStatement(sql);
            ps.setInt(1, id);
            ResultSet rs = ps.executeQuery();
    ...
    public void demanderHost(int id) {
        String sql = "UPDATE users SET role='ROLE_HOST_PENDING', " +
    ...
    public List<User> findHostPending() {
        List<User> liste = new ArrayList<>();
        String sql = "SELECT * FROM users WHERE role='ROLE_HOST_PENDING'";
        try {
            Statement stmt = connection.createStatement();
            ResultSet rs   = stmt.executeQuery(sql);
            while (rs.next()) liste.add(mapUser(rs));
